...
{
    public class RepeatableView : StackLayout
    {
        public static readonly BindableProperty ItemTemplateProperty = BindableProperty.Create(
            nameof(ItemTemplate), typeof(DataTemplate), typeof(RepeatableView), default(DataTemplate));

        public static readonly BindableProperty ItemsSourceProperty = BindableProperty.Create(
            nameof(ItemsSource), typeof(ICollection), typeof(RepeatableView), null, BindingMode.OneWay,
        ...
        private static void ItemsSourceChanging(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            {
                ov.CollectionChanged -= (bindable as RepeatableView).OnCollectionChanged;
            }
            if (newValue != null && newValue is INotifyCollectionChanged nv)
            {
                nv.CollectionChanged += (bindable as RepeatableView).OnCollectionChanged;
            }
        }
    }
}
